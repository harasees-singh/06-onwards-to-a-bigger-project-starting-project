...
const Meetup = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(meetups_MeetupDetail, _objectSpread({}, props.meetupData));
};

/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (Meetup);
const getStaticPaths = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect(mongoEndPoint);
  const db = client.db();
